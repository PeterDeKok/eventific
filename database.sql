...
INSERT INTO `events` VALUES (1,1,'Test Event 2.0','Description','2015-12-31 23:59:00',2,'Eindhoven',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (2,1,'Test Event 3.0','Description test 2','2015-01-24 21:00:00',360,'Breda',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (3,1,'Feestje','Feestje','2015-08-17 20:30:00',240,'Rucphen','Rucphen','2222GG','Unknown','100',555,'none');
INSERT INTO `events` VALUES (11,1,'Event 4.0','Description','2015-01-14 21:00:00',300,'Best',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (12,1,'Event 5.00','Omschrijving','2015-01-14 20:10:00',305,'Beste',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (14,3,'Test Event Cas','Description Cas','2015-01-23 00:02:00',340,'Eindhoven Cas',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (15,2,'Testing123','Description','2015-01-14 20:00:00',120,'bla',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (16,2,'Testing123','Description','2015-01-14 20:00:00',120,'bla',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (17,2,'Testing123','Description','2015-01-14 20:00:00',120,'bla',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (18,2,'Testblablalblalba','Description','2015-01-14 20:00:00',65,'here',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (19,2,'Testblablalblalba','Description','2015-01-14 20:00:00',65,'here',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (20,2,'Test23qwerqwer','Description','2015-01-14 20:00:00',45,'452',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (21,2,'asdfasdf','asdfasdfasdfasdfasdf','2016-01-01 20:00:00',120,'asdfasdfasdfasdf',NULL,NULL,'Unknown',NULL,NULL,'none');
INSERT INTO `events` VALUES (22,2,'Hardwell test event','Hardwell\'s test event, testing a lot more shit and giving it a boost, no idea how much text I still need to type, so just going on and on and on. There is snow outside and lalala on the radio. Just continuing... Barbra Streisand... Oeh food!','2015-01-25 20:03:00',121,'Eindhoven, Lempke',NULL,NULL,'Unknown',NULL,NULL,'event_b079266b2ee902b33afe3be2a5472ca3.jpg');
INSERT INTO `events` VALUES (23,2,'Avicci\'s Birthday Bash 2015','Avicci\'s Birthday celebration. Featuring Dan Tyminsk, Hardwell, Gregor Salto, Vato Gonzalez, Partysquad and many many more! Tickets available now. Be there and enjoy!','2015-04-05 20:30:00',360,'Klokgebouw Eindhoven',NULL,NULL,'Unknown',NULL,NULL,'event_313f04af40ff0131946b7030b71343f9.jpg');
INSERT INTO `events` VALUES (24,1,'Final test','Hopefully everything works!! ','2015-01-09 11:11:00',1111,'Home','Home','1111TT','Unknown','4000',4,'none');
INSERT INTO `events` VALUES (25,2,'Avicci\'s Birthday Bash 2015','Avicci\'s Birthday celebration. Featuring Dan Tyminsk, Hardwell, Gregor Salto, Vato Gonzalez, Partysquad and many many more! Tickets available now. Be there and enjoy!','2015-01-30 20:00:00',240,'Klokgebouw, Eindhoven','Klokgebouw 50','5617AB','Eindhoven','45',1000,'event_f6fb63a79b158bee80ab0655e33e18cd.jpg');
...
INSERT INTO `sessions` VALUES ('e1qi6cq0fiegetmudjrgbpukhaf319skbpgedke98u3e2ife9bk41lu05970p68s7uofkgprn17ejm72cat9lcpv7of21326292a090','1422443583','','b1284d3f1511e38334244bff02158cf19ccb3b455a0e70cad92ff7c62446ca862c4a2ee77824a12abf5b2bcfcf297b992dcd2aeba49eacb70af9564f90b1c50f');
...
-- Dump completed on 2015-01-28 12:14:02
